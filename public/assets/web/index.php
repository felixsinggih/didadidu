...
<head>
    ...
    <meta name="description" content="Didadidu adalah sentra layanan terpadu yang menggabungkan seluruh lini usaha yang di dukung oleh KPLI Banyumas dalam rangka menyediakan platform teknologi dan content serta solusi terkait IT yang anda butuhkan.">
    <meta name="keywords" content="Hosting, Web Hosting, Shared Hosting, Hosting Murah, Hosting Murah Indonesia, VPS, VPS Hosting, VPS Murah, VPS Murah Indonesia, Mail Server, Mail Server Murah, Software House Banyumas, Software House Cilacap, KPLI Banyumas, Komunitas Programmer Linux Indonesia">

    <title>Didadidu</title>
    <link href="/d_logo.png" rel="shortcut icon">
...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light px-md-4 mb-3 bg-body shadow-sm">
        <div class="container-fluid pt-2 pb-2">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <div class="d-flex">
                    <a class="btn btn-no-fill-red" href="#" style="margin-right: 10px">Contact Us</a>
                    <a class="btn btn-outline-red" href="#" style="margin-right: 10px">Contact Us</a>
            ...
            <div class="mx-auto d-flex flex-lg-row flex-column hero">
                ...
                <div class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center">
                    ...
                    <div class="d-flex flex-sm-row flex-column align-items-center mx-lg-0 mx-auto justify-content-center gap-3">
                        ...
                        <button class="btn btn-big btn-outline-red">
                            Watch the video
                        </button>
                    </div>
                </div>
    ...
    <!-- benefit potrait -->
    <section class="h1-00 w-100 bg-white" style="box-sizing: border-box"></section>
    <div class="benefit-potrait container-xxl mx-auto  position-relative" style="font-family: 'Poppins', sans-serif">
        <div class="d-flex flex-lg-row flex-column align-items-center">
            ...
            <div class="right-column d-flex flex-column align-items-lg-start align-items-center text-lg-start text-center">
                ...
                <ul style="padding: 0; margin: 0">
                    <li class="list-unstyled" style="margin-bottom: 2rem">
                        <h4 class="title-caption d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
                            <span class="circle circle-red text-white d-flex align-items-center justify-content-center">
                                1
                            </span>
                            Trusted Mentor
                        </h4>
                ...
                <button class="btn btn-big btn-red">Learn More</button>
            </div>
        </div>
    </div>
    </section>
    ...
    <section class="h-100 w-100 bg-light-blue" style="box-sizing: border-box">
        <div class="benefit-landscape container-xxl mx-auto p-0  position-relative" style="font-family: 'Poppins', sans-serif">
                ...
                <div class="card-red">
                    <div class="d-flex flex-lg-row flex-column align-items-center">
                        ...
                        <div class="card-btn-space">
                            <button class="btn btn-card-red">Buy Now</button>
                            <button class="btn btn-outline-red">Demo Version</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="h-100 w-100 bg-white" style="box-sizing: border-box;">
        <div class="pricing overflow-hidden container-xxl mx-auto position-relative" style="font-family: 'Poppins', sans-serif">
                    ...
                    <div class="mx-auto card-item position-relative">
                        <div class="card-item-outline bg-white d-flex flex-column position-relative overflow-hidden h-auto">
                            ...
                            <div class="price-list">
                                ...
                                <p class="d-flex align-items-center check">
                                    <span class="span-icon d-inline-flex align-items-center justify-content-center flex-shrink-0">
                                        <img class="img-fluid" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content3/Content-3-4.png" alt="" /> </span>Optimize Projects
                                </p>
                            </div>
                            <button class="btn btn-big btn-fill-red align-items-center w-100">
                                Choose Plan
                            </button>
                        </div>
                    </div>
                    <div class="mx-auto card-item position-relative">
                        <div class="card-item-outline d-flex flex-column position-relative overflow-hidden h-auto" style="background-color: #2e3a53">
                            ...
                            <div class="price-list">
                                <p class="d-flex align-items-center check text-white">
                                    <span class="span-icon d-inline-flex align-items-center justify-content-center flex-shrink-0">
                                        <img class="img-fluid" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content3/Content-3-6.png" alt="" /> </span>Chat Support
                                </p>
                                <p class="d-flex align-items-center check text-white">
                                    <span class="span-icon d-inline-flex align-items-center justify-content-center flex-shrink-0">
                                        <img class="img-fluid" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content3/Content-3-6.png" alt="" /> </span>Optimize Projects
                                </p>
                                <p class="d-flex align-items-center check text-white">
                                    <span class="span-icon d-inline-flex align-items-center justify-content-center flex-shrink-0">
                                        <img class="img-fluid" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content3/Content-3-6.png" alt="" /> </span>300+ Unique Project
                                </p>
                            </div>
                            <button class="btn btn-big btn-red align-items-center w-100">
                                Choose Plan
                            </button>
                        </div>
                    </div>
    ...
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #f5f5f5">
        <div class="login-box d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif">
            ...
            <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    ...
                    <p class="text-center bottom-caption">
                        ...
                        <span class="red-bottom-caption">Register Here</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row mx-0 text-center d-block">
                <div class="headline">
                    ...
                    <span class="cl-red font-red-hat-display">Manage Your Finances</span>
                </div>
            </div>
            <div class="value row mx-0 d-flex justify-content-center justify-content-md-between">
                ...
                <div class="card">
                    <div class="card-body p-0">
                        <i class="fas fa-shield-alt fa-5x cl-red"></i>
                        <div class="card-desc">
                ...
                <div class="card">
                    <div class="card-body p-0">
                        <i class="fas fa-project-diagram fa-5x cl-red"></i>
                        <div class="card-desc">
    ...
    <!-- footer -->
    <section class="h-100 w-100 bg-dark" style="box-sizing: border-box">
        <div class="footer container-xxl mx-auto position-relative p-0">
            <div class="list-footer">
                <div class="row gap-md-0 gap-3">
                    <div class="col-lg-3 col-md-6">
                        <div class="list-space">
                            <img src="/didadidu.png" height="40px" alt="" />
                        </div>
            ...
            <div class="border-color info-footer">
                ...
                <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
                    ...
                    <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
                        <p style="margin: 0">Copyright © 2021 Didadidu</p>
                    </nav>
                </div>
            </div>
        </div>
